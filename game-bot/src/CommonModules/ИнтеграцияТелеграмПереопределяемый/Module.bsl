...
Процедура ПриОбработкеЭлементаОчереди(ЭлементОчередиОбъект, ДанныеЭлемента) Экспорт
	...
	ИначеЕсли РежимРаботы = Перечисления.РежимРаботыБота.Квест Тогда
		ТелеграмКвест.ПриОбработкеЭлементаОчереди(ДанныеЭлемента, ЭлементОчередиОбъект.Отправитель);
	Иначе
